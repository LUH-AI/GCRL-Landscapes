...
for algorithm in "CRL" "GCBC"; do
  for environment in "navigate" "explore" "stitch"; do
    ...
    python -m gcrl_landscapes.main submit --logdir "./logs/${algorithm}_${environment}_32c_disc-acttraj" --n_seeds 5 --tasks_per_node 5 --jobname "${algorithm}_${environment}" --partition "ai,tnt"
  done
done
