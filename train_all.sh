...
logdir="./logs_antmaze-large-qrl-lr-alpha-alternative-convergence"
...
declare -a -r environments=(
  #"antmaze-large-explore-v0 antmaze-large-explore80navigate-v0 antmaze-large-explore40navigate-v0 antmaze-large-navigate-v0"
