...
for algorithm in "CRL" "GCBC"; do
  for environment in "navigate" "explore" "stitch"; do
    ...
    python -m gcrl_landscapes.main submit --logdir "./logs/${algorithm}_${environment}_32c_disc-acttraj" --phase 0 --n_seeds 3 --tasks_per_node 4 --jobname "${algorithm}_${environment}" --partition "ai,tnt"
  done
done
